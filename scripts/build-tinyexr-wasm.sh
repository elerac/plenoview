...
emcc -O3 \
  ...
  -s 'EXPORTED_FUNCTIONS=["_pexr_decode","_pexr_width","_pexr_height","_pexr_num_parts","_pexr_part_name","_pexr_part_width","_pexr_part_height","_pexr_num_channels","_pexr_channel_name","_pexr_channel_pixels","_pexr_channel_length","_pexr_channel_finite_count","_pexr_channel_finite_min","_pexr_channel_finite_max","_pexr_last_error","_pexr_last_stage","_pexr_last_reason","_pexr_last_part","_pexr_last_block","_pexr_last_error_string","_pexr_free","_malloc","_free"]' \
  -s 'EXPORTED_RUNTIME_METHODS=["HEAPU8","HEAPF32"]' \
  -o "$output_root/tinyexr_wasm.js"

chmod 0644 "$output_root/tinyexr_wasm.js" "$output_root/tinyexr_wasm.wasm"

echo "Built TinyEXR v3.2.0 WASM with Emscripten ${required_emscripten_version}:"
wc -c "$output_root/tinyexr_wasm.js" "$output_root/tinyexr_wasm.wasm"
